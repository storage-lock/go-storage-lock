...
func (x *StorageLock) cleanExpiredLockAndRetry(ctx context.Context, ownerId string, lockInformation *storage.LockInformation) error {
	...
	_ = x.storage.DeleteWithVersion(ctx, x.options.LockId, lockInformation.Version, lockInformation)
...
// 获取之前的锁保存的信息
func (x *StorageLock) getLockInformation(ctx context.Context) (*storage.LockInformation, error) {
